...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $noteModel->addNote($userId, $content);
    header("Location: " . BASE_URL . "?page=note_summary");
    exit;
}
?>

<h1 class="text-2xl font-semibold mb-6">Add Note</h1>
...
<form method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mt-4">Add Note</button>
</form>

...
$user = $userModel->getUserById($userId); $userMeta =
$userModel->getUserMetaById($userId); $defaultImage =
...
// Correctly get the page name from URL $currentPage = isset($_GET['page']) ?
$_GET['page'] ; 'dashboard'; $pageTitle = isset($pageTitles[$currentPage]) ?
$pageTitles[$currentPage] : 'Page'; // Start output buffering ob_start(); ?>
      ...
      <nav class="mt-10 flex flex-col main-nav-menu">
        ...
        <div id="income-submenu" class="submenu ml-10 mt-2">
          <a
            ...
            class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white text-gray-600"
          >
      ...
      <header class="bg-white shadow-md p-4 flex justify-between items-center">
        ...
        <div class="flex items-center">
          ...
          <img class="w-10 h-10 rounded-full" src="<?php echo !empty($userMeta['photo_path']) ? '/uploads/' . $userMeta['photo_path'] : $defaultImage; ?>" alt="Profile Image">
            ...
            <div
              class="dropDownMenu border-2 shadow-xl bg-white flex flex-col p-4"
            >
              <h1
                class="font-semibold w-full hover:bg-gray-700 hover:text-white text-gray-600 py-2 rounded-md"
              >
                View Profile
              </h1>
              <h1
